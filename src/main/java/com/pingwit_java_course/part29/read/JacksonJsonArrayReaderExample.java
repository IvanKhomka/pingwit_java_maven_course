...
public class JacksonJsonArrayReaderExample {
    public static void main(String[] args) throws IOException {
        ...
        InputStream jsonFileStream = ClassLoader.getSystemResourceAsStream("part29/read/json_array_simple.json");
        ...
        InputStream jsonTaxiDrivers = ClassLoader.getSystemResourceAsStream("part29/read/json_array_complex.json");
