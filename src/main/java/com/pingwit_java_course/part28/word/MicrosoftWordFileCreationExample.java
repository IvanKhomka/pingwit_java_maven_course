package com.pingwit_java_course.part28.word;
...
public class MicrosoftWordFileCreationExample {
    ...
    private static void createImage(XWPFDocument document, Path imagePath) throws Exception {
        ...
        imageRun.addPicture(Files.newInputStream(imagePath), XWPFDocument.PICTURE_TYPE_PNG, imagePath.toFile().getName(), Units.toEMU(200), Units.toEMU(200));
    }

    private static void write(XWPFDocument document) {
        String currentDirectory = "src/main/java/com/pingwit_java_course/part28/word";
