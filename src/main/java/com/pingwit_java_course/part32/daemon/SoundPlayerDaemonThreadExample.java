package com.pingwit_java_course.part32.daemon;
...
public class SoundPlayerDaemonThreadExample {
    public static void main(String[] args) throws Exception {
        ...
        Runnable soundPlayer = () -> {
            try {
                InputStream soundInputStream = ClassLoader.getSystemResourceAsStream("part32/daemon/Imagine Dragons - Demons.WAV");
